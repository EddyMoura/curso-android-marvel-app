...
import com.example.core.usecase.GetCharacterCategoryUseCase.GetComicsParams
...
) : GetCharacterCategoryUseCase, UseCase<GetComicsParams, Pair<List<Comic>, List<Event>>>() {
